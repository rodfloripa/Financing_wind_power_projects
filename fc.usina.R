...
anosi <- 2
#en <- readline(prompt="Entre com a energia produzida por ano em mil MWh:")
#en <- 89.719
#en <- 124.0 # valor de 2015
#inv <- readline(prompt="Entre com o investimento total em mil R$:")
#inv <- 82681.8
#inv <- 122000  #valor de 2015
...
#pld <- readline(prompt="Entre com o preço da energia em R$/MWh:")
#pld <- 110.51
#pld <- 144 #reajustado pelo teto do leilao
